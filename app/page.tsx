    ...
    <div className="flex flex-1 flex-col bg-paper">
      <header className="mx-auto w-full max-w-5xl px-6 pt-10 pb-4 sm:px-8">
        ...
        <p className="mt-2 max-w-md font-body text-ink-soft">
          Turn any photo into a black-and-white page, ready to print on A4 and colour in.
        </p>
      </header>
        ...
        {status !== "ready" && (
          <div className="flex flex-1 items-center justify-center py-8">
            ...
            >
              ...
              <p className="mt-1 text-sm text-ink-soft">or choose a file from your device</p>

              <label className="mt-5 inline-flex min-h-11 cursor-pointer items-center justify-center rounded-full bg-coral px-6 font-body font-semibold text-white transition-colors hover:bg-coral-dark">
        ...
        {status === "ready" && edgeMap && (
          <div className="grid flex-1 gap-8 py-6 lg:grid-cols-[280px_1fr]">
            <div className="flex flex-col gap-6">
              <div>
                <p className="mb-2 text-sm font-semibold text-ink-soft">Original photo</p>
                {originalUrl && (
                  // eslint-disable-next-line @next/next/no-img-element
                  <img
                    src={originalUrl}
                    alt="Original photo you uploaded"
